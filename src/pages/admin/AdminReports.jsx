  ...
  return (
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Title level={3} style={{ margin: 0 }}>Báo cáo & Thống kê kinh doanh</Title>
        <Space>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} lg={14}>
          <Card title="Diễn biến doanh thu gần đây" style={{ height: '100%' }}>
            <Table 
          ...
          <Card title="Top Khách sạn doanh thu cao">
            {topHotels.map((item, index) => (
              <div key={index} style={{ marginBottom: '20px' }}>
                ...
                <Progress percent={item.rate} status="active" strokeColor={index === 0 ? '#ff4d4f' : '#1890ff'} />
              </div>
            ))}
          </Card>
        </Col>
